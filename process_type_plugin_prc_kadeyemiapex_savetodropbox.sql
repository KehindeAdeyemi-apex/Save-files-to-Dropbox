...
--   Date and Time:   16:20 Saturday April 24, 2021
--   Exported By:     HUMBRE
--   Flashback:       0
--   Export Type:     Component Export
--   Manifest
--     PLUGIN: 44539716366798875
--   Manifest End
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(44539716366798875)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(44539938495798883)
,p_plugin_id=>wwv_flow_api.id(44539716366798875)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(44540327596798884)
,p_plugin_id=>wwv_flow_api.id(44539716366798875)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(44540720703798884)
,p_plugin_id=>wwv_flow_api.id(44539716366798875)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(44548627164903817)
,p_plugin_attribute_id=>wwv_flow_api.id(44540720703798884)
,p_display_sequence=>10
,p_display_value=>'public'
,p_return_value=>'public'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(44549087487906275)
,p_plugin_attribute_id=>wwv_flow_api.id(44540720703798884)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(44549480948907468)
,p_plugin_attribute_id=>wwv_flow_api.id(44540720703798884)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(44541184584798885)
,p_plugin_id=>wwv_flow_api.id(44539716366798875)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(44550000732913610)
,p_plugin_attribute_id=>wwv_flow_api.id(44541184584798885)
,p_display_sequence=>10
,p_display_value=>'public'
,p_return_value=>'public'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(44550487718917084)
,p_plugin_attribute_id=>wwv_flow_api.id(44541184584798885)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(44550878889918515)
,p_plugin_attribute_id=>wwv_flow_api.id(44541184584798885)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(44551289901919571)
,p_plugin_attribute_id=>wwv_flow_api.id(44541184584798885)
,p_display_sequence=>40
,p_display_value=>'password'
,p_return_value=>'password'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(44541543771798885)
,p_plugin_id=>wwv_flow_api.id(44539716366798875)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(44541971991798885)
,p_plugin_attribute_id=>wwv_flow_api.id(44541543771798885)
,p_display_sequence=>10
,p_display_value=>'viewer'
,p_return_value=>'viewer'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(44542403273798886)
,p_plugin_attribute_id=>wwv_flow_api.id(44541543771798885)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(44542946035798886)
,p_plugin_attribute_id=>wwv_flow_api.id(44541543771798885)
,p_display_sequence=>30
,p_display_value=>'max'
,p_return_value=>'max'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(44546605221798888)
,p_plugin_id=>wwv_flow_api.id(44539716366798875)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(44547055325798888)
,p_plugin_id=>wwv_flow_api.id(44539716366798875)
,p_attribute_scope=>'COMPONENT'
